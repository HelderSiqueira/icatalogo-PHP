      ...
      <main>
        <form class="form-produto" method="POST" action="../acoes.php" enctype="multipart/form-data">
          ...
          <div class="input-group">
            ...
            <input type="text" value="<?= number_format($produto['peso'], 2, ",", ".") ?>" name="peso" id="peso" required>
          </div>
          <div class="input-group">
          ...
          <div class="input-group">
            ...
            <input type="text" value="<?= $produto['tamanho'] ?>" name="tamanho" id="tamanho" required>
          </div>
          <div class="input-group">
          ...
          <div class="input-group">
            ...
            <input type="text" value="<?= $produto['desconto'] ?>" name="desconto" id="desconto" required>
          </div>
          <div class="input-group">
